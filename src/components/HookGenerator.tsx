    ...
    <div className="max-w-2xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 text-lg md:text-xl">
          Enter any topic and get 5 viral hooks generated by advanced AI
        </p>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="flex flex-wrap gap-2">
          {['AI & Technology', 'Business Growth', 'Personal Development', 'Health & Fitness', 'Content Creation', 'Entrepreneurship'].map((quickTopic) => (
            <button
              key={quickTopic}
